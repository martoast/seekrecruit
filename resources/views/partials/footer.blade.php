<footer class="bg-dark-500 text-white mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('positions.index') }}" class="text-gray-300 hover:text-white transition-colors">Browse Positions</a></li>
        ...
        <div class="border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>&copy; {{ now()->year }} Seek & Recruit Network. All rights reserved.</p>
        </div>
    </div>
</footer>
