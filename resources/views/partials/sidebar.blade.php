@php
    ...
    $navItems = [
        ...
        ['label' => 'Lessons', 'route' => 'admin.lessons.index', 'active' => 'admin.lessons.*', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
        ...
        <div class="flex-shrink-0 px-3 py-3 border-t border-gray-200">
            <div class="flex items-center px-3 py-2 mb-2">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    @if ($user?->isHrAdmin() && $user->client)
                        <p class="text-xs text-primary-600 font-medium truncate mt-0.5">{{ $user->client->name }}</p>
