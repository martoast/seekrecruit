<?php $__env->startSection('title', $position->title . ' - Seek & Recruit Network'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.badge','data' => ['variant' => 'success','class' => 'mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'success','class' => 'mb-3']); ?>Open Position <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <?php endif; ?>
                    <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2"><?php echo e($position->title); ?></h1>
                    <div class="flex flex-wrap items-center gap-4 text-white/90">
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            Posted <?php echo e($position->created_at->format('F j, Y')); ?>
            ...
            <div class="space-y-6">
                <?php if(!$position->image_url): ?>
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($position->title); ?></h1>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'success']); ?>Open <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4)): ?>
<?php $attributes = $__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4; ?>
<?php unset($__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4); ?>
                ...
                <?php if($position->company_name || $position->company_logo_url): ?>
                    <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                        <?php if($position->company_logo_url): ?>
                            <img src="<?php echo e($position->company_logo_url); ?>" alt="<?php echo e($position->company_name ?? 'Company'); ?>" class="w-14 h-14 rounded-xl object-contain bg-white border border-gray-200 p-1" />
                        <?php else: ?>
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($position->company_name ?? 'Company'); ?></p>
                        </div>
                    </div>
                <?php endif; ?>

                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isCandidate() && $isOpen): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary']); ?>View My Applications <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('candidate.applications.store')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'primary']); ?>Apply Now <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary']); ?>Back to Positions <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="text-gray-700 whitespace-pre-line"><?php echo e($position->description); ?></div>
                </div>

                <div class="border-t border-gray-200 pt-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Requirements</h2>
                    <div class="text-gray-700 whitespace-pre-line"><?php echo e($position->requirements); ?></div>
                </div>
            </div>
        ...
        <?php if(auth()->guard()->guest()): ?>
            <div class="text-center py-8">
                ...
                <div class="flex gap-3 justify-center">
                    <a href="<?php echo e(route('login')); ?>"><?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary']); ?>Login <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?></a>
                    <a href="<?php echo e(route('register')); ?>"><?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/positions/show.blade.php ENDPATH**/ ?>