<?php $__env->startSection('title', 'Edit ' . $client->name . ' - Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden max-w-2xl">
            <form method="POST" action="<?php echo e(route('admin.clients.update', $client)); ?>" class="divide-y divide-gray-100">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="p-6 space-y-6">
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['label' => 'Name','name' => 'name','value' => $client->name,'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Name','name' => 'name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($client->name),'required' => true]); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['label' => 'Slug','name' => 'slug','value' => $client->slug,'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Slug','name' => 'slug','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($client->slug),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['label' => 'Industry','name' => 'industry','value' => $client->industry]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Industry','name' => 'industry','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($client->industry)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select','data' => ['label' => 'Status','name' => 'is_active','required' => true,'value' => old('is_active', $client->is_active ? 1 : 0),'options' => [1 => 'Active', 0 => 'Inactive']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Status','name' => 'is_active','required' => true,'value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_active', $client->is_active ? 1 : 0)),'options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([1 => 'Active', 0 => 'Inactive'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0">
                        <?php if($client->logo_url): ?>
                            <img src="<?php echo e($client->logo_url); ?>" alt="<?php echo e($client->name); ?> logo" class="w-20 h-20 rounded-xl object-contain bg-white border border-gray-200 p-1" />
                        <?php else: ?>
                    ...
                    <div class="flex-1 space-y-2">
                        <form method="POST" action="<?php echo e(route('admin.clients.logo.store', $client)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <label class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer w-fit">
                                ...
                                <?php echo e($client->logo_url ? 'Change Logo' : 'Upload Logo'); ?>

                            </label>
                            <p class="mt-1 text-xs text-gray-500">JPEG, PNG, WebP, SVG. Max 2MB. Square works best.</p>
                        </form>
                        <?php if($client->logo_url): ?>
                            <form method="POST" action="<?php echo e(route('admin.clients.logo.destroy', $client)); ?>">
                                <?php echo csrf_field(); ?>
        ...
        <form id="delete-client-form" method="POST" action="<?php echo e(route('admin.clients.destroy', $client)); ?>" onsubmit="return confirm('Archive this client? Positions will be hidden; applications stay in the history. You can restore the client from the database if needed.');" class="hidden">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
        </form>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/clients/edit.blade.php ENDPATH**/ ?>