<?php $__env->startSection('title', 'Applications - Admin'); ?>
        ...
        <div class="mb-8">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <form method="GET" class="relative w-full sm:w-auto sm:min-w-[280px]">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search applications..." class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all bg-white" />
                </form>
            </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['in_interview']); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-xl border border-gray-200 p-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['hired']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-12">
                <div class="text-center max-w-md mx-auto">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">
                        <?php echo e(request('search') ? 'No applications found' : 'No applications yet'); ?>

                    </h3>
                    <p class="text-gray-500">
                        <?php echo e(request('search') ? 'Try adjusting your search query.' : 'Applications will appear here when candidates apply.'); ?>
...
<?php endif; ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($app->created_at->format('M j, Y')); ?></p>
                                        <p class="text-sm text-gray-500"><?php echo e($app->created_at->diffForHumans()); ?></p>
                                    </td>
                                    <td class="px-6 py-4">
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($app->updated_at->format('M j, Y')); ?></p>
                                        <p class="text-sm text-gray-500"><?php echo e($app->updated_at->diffForHumans()); ?></p>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?php echo e(route('admin.applications.show', $app)); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg">
                                            Review
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/Seagate/Max/Seekrecruit/seekrecruit/resources/views/admin/applications/index.blade.php ENDPATH**/ ?>