<?php $__env->startSection('title', 'Dashboard - Seek & Recruit Network'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.badge','data' => ['variant' => $profileProgress === 100 ? 'success' : 'warning']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($profileProgress === 100 ? 'success' : 'warning')]); ?>
                        <?php echo e($profileProgress); ?>%
...
<?php endif; ?>
                ...
                <div class="relative pt-1">
                    <div class="overflow-hidden h-3 text-xs flex rounded-full bg-gray-200">
                        <div
                            style="width: <?php echo e($profileProgress); ?>%"
                ...
                <?php if($profileProgress < 100): ?>
                    <div class="mt-6 space-y-2">
                        ...
                        <ul class="text-sm text-gray-600 space-y-1">
                            ...
                            <?php endif; ?>
                            <?php if (! (is_array($profile->skills) && count($profile->skills))): ?>
                                <li class="flex items-center">
                                    <svg class="h-4 w-4 mr-2 text-amber-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"/></svg>
                                    Add your skills
                                </li>
                        ...
                        <a href="<?php echo e(route('candidate.profile.edit')); ?>" class="inline-block mt-4">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'sm']); ?>Complete Profile <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="<?php echo e(route('candidate.profile.edit')); ?>">
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['padding' => 'md','class' => 'hover:border-primary-300 transition-all cursor-pointer h-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['padding' => 'md','class' => 'hover:border-primary-300 transition-all cursor-pointer h-full']); ?>
...
<?php $component->withAttributes(['padding' => 'md','class' => 'hover:border-primary-300 transition-all cursor-pointer h-full']); ?>
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900"><?php echo e($applications->count()); ?> Active</p>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','size' => 'sm']); ?>View All → <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php echo $__env->make('layouts.candidate', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/candidate/dashboard.blade.php ENDPATH**/ ?>